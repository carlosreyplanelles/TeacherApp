...
const sqlTeachersData= 'select u.id as user_id, u.name,u.surname,u.email,u.creation_date,t.id as teacher_id,' +
...
module.exports = {
    getAllTeachers, getTeachersByPage, getTeacherByUserId, getTeacherById, getTeacherByEmail, getBranchById, createTeacher, deleteTeacherById, updateTeacher
}
